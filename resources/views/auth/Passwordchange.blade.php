        ...
        <div class="user-sidebar">
            ...
            <div class="sidebar-inner">
                <ul class="navigation">
                    ...
                    <li class="active"><a href="{{ route('auth.Passwordchange') }}"><i class="la la-lock"></i>Changer le mot de passe </a></li>
             ...
             @endif 
              ...
              <div class="ls-widget">
                ...
                <div class="widget-content">
                  <form class="default-form" method="post" action="{{ route('auth.UUpdatePassword') }}">
                    @csrf
                    <div class="row">
                      <!-- Input -->
